...
describe 'eucalyptus::nc', :type => :class do
  ...
  context "When on a RedHat system" do
    ...
    context 'when fed no parameters' do
      it 'should contain the eucalyptus::nc class'do
        should contain_class('Eucalyptus::Nc').with({
          :cloud_name=>"cloud1",
          :cluster_name=>"cluster1"
        })
      end
      it {should contain_class('eucalyptus::nc::config')}
      it {should contain_class('eucalyptus::nc::install')}
      it {should contain_class('eucalyptus::nc::reg')}
    end#no params
  end
end
