...
describe 'eucalyptus::nc::config', :type => :class do
...
#    end#opt_strings
  ...
  context "When on a RedHat-esque system" do
    ...
    #let(:pre_condition) { ['class{"eucalyptus::Clc": cloud_name => "cloud1", before =>"Class[Eucalyptus::nc]" }', 'eucalyptus::cluster{"mycluster": cloud_name => "cloud1", cluster_name => "cluster1"}' ] }
