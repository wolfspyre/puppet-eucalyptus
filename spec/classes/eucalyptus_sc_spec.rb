...
describe 'eucalyptus::sc', :type => :class do
  ...
  context "When on a RedHat system" do
    ...
    context 'when fed no parameters' do
      it 'should contain the eucalyptus::sc class'do
        should contain_class('Eucalyptus::Sc').with({
          :cloud_name=>"cloud1",
          :cluster_name=>"cluster1"
        })
      end
      it {should contain_class('eucalyptus::sc::config')}
      it {should contain_class('eucalyptus::sc::install')}
      it {should contain_class('eucalyptus::sc::reg')}
    end#no params
  end
end
