...
describe 'eucalyptus::walrus', :type => :class do
  ...
  context "When on a RedHat system" do
    ...
    context 'when fed no parameters' do
      it 'should contain the eucalyptus::walrus class'do
        should contain_class('Eucalyptus::Walrus').with({
          :cloud_name=>"cloud1"
        })
      end
      it {should contain_class('eucalyptus::walrus::config')}
      it {should contain_class('eucalyptus::walrus::install')}
      it {should contain_class('eucalyptus::walrus::reg')}
    end#no params
  end
end
